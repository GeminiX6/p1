...
<body>
    ...
    <div class="pure-menu pure-menu-horizontal">
      <ul class="pure-menu-list">
          ...
          <li class="pure-menu-item pure-menu-has-children pure-menu-allow-hover">
              ...
              <ul class="pure-menu-children">
                  <li class="pure-menu-item"><a href="http://p3.matthewcole.tech" class="pure-menu-link">View Site</a></li>
                  <li class="pure-menu-item"><a href="https://github.com/GeminiX6/p3" class="pure-menu-link">View Github</a></li>
              </ul>
          </li>
          <li class="pure-menu-item pure-menu-has-children pure-menu-allow-hover">
              <a href="#" id="menuLink3" class="pure-menu-link">Project 4</a>
              <ul class="pure-menu-children">
                  <li class="pure-menu-item"><a href="http://p4.matthewcole.tech" class="pure-menu-link">View Site</a></li>
                  <li class="pure-menu-item"><a href="https://github.com/GeminiX6/p4" class="pure-menu-link">View Github</a></li>
              </ul>
          </li>
      </ul>
  </div>
  ...
  <br>
    ...
    <h2>In 2+ sentences describe who you are and what you do.</h2>
		...
		<p>I'm working towards my masters in Information Management Systems so that I can grow within my company.</p>

		<h2>What previous experience do you have with programming?</h2>
		<p>I have programmed in HTML, CSS, C++ and Java.</p>

		<h2>Are you working on a Mac, PC, or some other platform?</h2>
		<p>I am working on a PC that I built myself from scratch, running Windows 10.</p>
